...
- **Marketing Compliance**: Maximize the marketing aspect by structuring docs to put best features forward, but keep rhetoric tasteful, professional, and not hyperbolic or grandiose. Ensure standard `README.md` and Wikis have a prominent "Value Proposition" block at the top. Use active voice, benefit-driven headers, and concise sentences (<15 words). **CRITICAL EXCEPTION**: `AGENT_README.md` files must remain strictly agent-optimized. Do NOT add marketing fluff, value proposition blocks, or tone enhancements to any `AGENT_README.md` file.
...
3. **Dispatch Subagents**:
   ...
   - **Crucial Instructions for Subagents**: 
     ...
     - "Enhance the marketing tone of technical docs to emphasize core value, but keep it tasteful, professional, and avoid hyperbolic or grandiose rhetoric. **CRITICAL EXCEPTION**: `AGENT_README.md` files must remain strictly agent-optimized. Do NOT add marketing fluff, value proposition blocks, or tone enhancements to any `AGENT_README.md` file."
