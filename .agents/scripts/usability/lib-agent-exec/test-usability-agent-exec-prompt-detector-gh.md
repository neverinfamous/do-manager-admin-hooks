# Usability Test: Agent-Exec Prompt Detector (GH Prompts)
...
## Objective
Verify that `lib-agent-exec` heuristically detects interactive `gh` style prompts (`title:`, `body:`).

## Instructions

### Phase 1: Adversarial Execution
1. **Interactive Prompts:** Test `gh` style prompts (`title:`, `body:`).
