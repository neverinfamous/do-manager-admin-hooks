# Usability Test: Agent-Exec Prompt Detector (Progress Bars)
...
## Objective
Verify that `lib-agent-exec` heuristically detects progress bars that can cause noisy/infinite loops.

## Instructions

### Phase 1: Adversarial Execution
1. **Interactive Prompts:** Test progress bars (e.g. `[████████████████████] 100%`).
