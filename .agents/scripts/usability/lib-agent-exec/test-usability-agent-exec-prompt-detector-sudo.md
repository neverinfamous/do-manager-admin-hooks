# Usability Test: Agent-Exec Prompt Detector (Sudo)
...
## Objective
Verify that `lib-agent-exec` heuristically detects and aborts interactive sudo and password prompts (e.g., `[sudo] password for user:`, `Password:`).

## Instructions

### Phase 1: Adversarial Execution
1. **Interactive Prompts:** Test sudo and password prompts.
