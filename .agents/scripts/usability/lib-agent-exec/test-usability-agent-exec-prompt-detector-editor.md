# Usability Test: Agent-Exec Prompt Detector (Editor)
...
## Objective
Verify that `lib-agent-exec` heuristically detects and aborts interactive editor blocks (e.g., Emacs/Vi).

## Instructions

### Phase 1: Adversarial Execution
1. **Interactive Prompts:** Test editor blocks (e.g., `Waiting for Emacs...`).
